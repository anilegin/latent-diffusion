#!/bin/bash
#SBATCH --job-name=ldm-coco256-evaluate
...
python scripts/evaluate_custom_generation_timing.py \
  --config configs/experiments/evaluate_custom_generation_timing.yaml \
  --monitor-gpu
